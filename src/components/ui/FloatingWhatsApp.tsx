    ...
    return (
        ...
        >
            <button className="relative bg-green-500 text-white w-14 h-14 rounded-full flex justify-center items-center shadow-lg hover:bg-green-600 transition-all duration-300 ease-out z-50 hover:scale-105 active:scale-95 cursor-pointer" aria-label="WhatsApp Hattı">
                ...
                <span className="absolute inset-0 rounded-full border-4 border-white/30 scale-100 animate-pulse pointer-events-none" />
                <div className="absolute right-full mr-3 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-300 whitespace-nowrap">
                    <div className="bg-gray-800 text-white text-sm px-4 py-2 rounded-lg shadow-lg relative font-medium">
                        Temsilcimiz mesajınızı bekliyor
